...
Translator.prototype.getCatalogs = function() {
  ...
  var catalogList = lodash.map(locales, lodash.bind(parseCatalog, this));
...
Translator.prototype.register = function(fileExts, translator) {
  ...
  lodash.forEach(fileExts, lodash.bind(regExt, this));
};
...
Translator.prototype.translate = function(file) {
  ...
  lodash.forEach(locales, lodash.bind(translateFile, this));
