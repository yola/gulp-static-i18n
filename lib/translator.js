...
var createMsgParseFn = function(defaultLang, localeDirs) {
  return function(lang) {
    if (lang === defaultLang) {
      return {};
    }
    var parsePoFn = createPoParseFn(lang);
    var jsonPoArray = lodash.map(localeDirs, parsePoFn);
...
Translator.prototype.getCatalogs = function() {
  ...
  var parseMessages = createMsgParseFn(this.options.defaultLang, this.options.localeDirs);
